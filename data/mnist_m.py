...
class MNISTM(data.Dataset):
    ...
    def __init__(self, root='/home/chenshuo/dann/data/MNIST_M/', mnist_root="/home/chenshuo/dann/data/MNIST", train=True, transform=None, target_transform=None, download=True):
    ...
    def download(self):
        ...
        print("Done!")
train_data=MNISTM(transform=transforms.ToTensor())
